...
public class DgGlobalStriders implements Dialog {

    @Override
    public Menu create(Player p, Object... args) {
        MenuBuilder builder = new MenuBuilder("HOT STRIDERS IN YOUR AREA", MenuSize.SIX_ROWS, p);


        builder.addButtonByColumnRow(new MenuButton(Material.PAPER, 1,
                "Click here to find out more!"), 3, 1, true);
        ...
        builder.addButtonByColumnRow(new MenuButton(Material.LAVA_BUCKET, 1, " "), 1, 5, true);
        builder.addButtonByColumnRow(new MenuButton(Material.SADDLE, 1, " "), 2, 5, true);
        builder.addButtonByColumnRow(new MenuButton(Material.WARPED_FUNGUS_ON_A_STICK, 1, " "), 3, 5, true);
        builder.addButtonByColumnRow(new MenuButton(Material.SADDLE, 1, " "), 4, 5, true);
        builder.addButtonByColumnRow(new MenuButton(Material.LAVA_BUCKET, 1, " "), 5, 5, true);
