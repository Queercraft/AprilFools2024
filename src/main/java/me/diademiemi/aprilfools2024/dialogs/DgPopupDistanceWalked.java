...
public class DgPopupDistanceWalked implements Dialog {

    @Override
    public Menu create(Player p, Object... args) {
        MenuBuilder builder = new MenuBuilder("That's one small step for man...", MenuSize.SIX_ROWS, p);


        builder.addButtonByColumnRow(new MenuButton(Material.PAPER, 1,
                "Or about two hundred if you were really counting"), 3, 1, true);
        ...
        builder.addButtonByColumnRow(new MenuButton(Material.END_STONE, 1, " "), 1, 5, true);
        builder.addButtonByColumnRow(new MenuButton(Material.END_STONE, 1, " "), 2, 5, true);
        builder.addButtonByColumnRow(new MenuButton(Material.END_STONE, 1, " "), 3, 5, true);
        builder.addButtonByColumnRow(new MenuButton(Material.END_STONE, 1, " "), 4, 5, true);
        builder.addButtonByColumnRow(new MenuButton(Material.END_STONE, 1, " "), 5, 5, true);
