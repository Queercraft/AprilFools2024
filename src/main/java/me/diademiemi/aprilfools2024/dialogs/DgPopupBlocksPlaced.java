...
public class DgPopupBlocksPlaced implements Dialog {

    @Override
    public Menu create(Player p, Object... args) {
        MenuBuilder builder = new MenuBuilder("Block Placement Limit Reached", MenuSize.SIX_ROWS, p);


        builder.addButtonByColumnRow(new MenuButton(Material.STONE, 1,
                "Please renew your Minecraft license."), 3, 1, true);
        ...
        builder.addButtonByColumnRow(new MenuButton(Material.NAME_TAG, 1, " "), 1, 5, true);
        builder.addButtonByColumnRow(new MenuButton(Material.NAME_TAG, 1, " "), 2, 5, true);
        builder.addButtonByColumnRow(new MenuButton(Material.NAME_TAG, 1, " "), 3, 5, true);
        builder.addButtonByColumnRow(new MenuButton(Material.NAME_TAG, 1, " "), 4, 5, true);
        builder.addButtonByColumnRow(new MenuButton(Material.NAME_TAG, 1, " "), 5, 5, true);
