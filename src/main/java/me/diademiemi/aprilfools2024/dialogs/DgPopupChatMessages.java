...
public class DgPopupChatMessages implements Dialog {

    @Override
    public Menu create(Player p, Object... args) {
        MenuBuilder builder = new MenuBuilder("Your free trial has expired", MenuSize.SIX_ROWS, p);


        builder.addButtonByColumnRow(new MenuButton(Material.PAPER, 1,
                "Subscribe to LGBTQ+ for the full Queercraft experience"), 3, 1, true);
        ...
        builder.addButtonByColumnRow(new MenuButton(Material.RED_CONCRETE, 1, " "), 1, 5, true);
        builder.addButtonByColumnRow(new MenuButton(Material.ORANGE_CONCRETE, 1, " "), 2, 5, true);
        builder.addButtonByColumnRow(new MenuButton(Material.YELLOW_CONCRETE, 1, " "), 3, 5, true);
        builder.addButtonByColumnRow(new MenuButton(Material.LIME_CONCRETE, 1, " "), 4, 5, true);
        builder.addButtonByColumnRow(new MenuButton(Material.BLUE_CONCRETE, 1, " "), 5, 5, true);
