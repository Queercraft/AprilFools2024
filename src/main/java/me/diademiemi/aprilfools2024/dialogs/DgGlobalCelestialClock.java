...
public class DgGlobalCelestialClock implements Dialog {

    @Override
    public Menu create(Player p, Object... args) {
        MenuBuilder builder = new MenuBuilder("Need to see the time?", MenuSize.SIX_ROWS, p);


        builder.addButtonByColumnRow(new MenuButton(Material.CLOCK, 1,
                "Now you can!"), 3, 1, true);
        ...
        builder.addButtonByColumnRow(new MenuButton(Material.GOLD_NUGGET, 1, " "), 1, 5, true);
        builder.addButtonByColumnRow(new MenuButton(Material.GOLD_INGOT, 1, " "), 2, 5, true);
        builder.addButtonByColumnRow(new MenuButton(Material.GOLD_BLOCK, 1, " "), 3, 5, true);
        builder.addButtonByColumnRow(new MenuButton(Material.GOLD_INGOT, 1, " "), 4, 5, true);
        builder.addButtonByColumnRow(new MenuButton(Material.GOLD_NUGGET, 1, " "), 5, 5, true);
