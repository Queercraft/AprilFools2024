...
public class DgPopupDistanceByBoat implements Dialog {

    @Override
    public Menu create(Player p, Object... args) {
        MenuBuilder builder = new MenuBuilder("You don't have life jackets...", MenuSize.SIX_ROWS, p);


        builder.addButtonByColumnRow(new MenuButton(Material.PAPER, 1,
                "FINE: M250.00"), 3, 1, true);
        ...
        builder.addButtonByColumnRow(new MenuButton(Material.WHITE_CONCRETE, 1, " "), 2, 5, true);
        builder.addButtonByColumnRow(new MenuButton(Material.RED_CONCRETE, 1, " "), 3, 5, true);
        builder.addButtonByColumnRow(new MenuButton(Material.WHITE_CONCRETE, 1, " "), 4, 5, true);
        builder.addButtonByColumnRow(new MenuButton(Material.RED_CONCRETE, 1, " "), 5, 5, true);
